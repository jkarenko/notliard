...
export default class Door extends Phaser.GameObjects.Rectangle {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, destination: string, targetX?: number, targetY?: number, triggerType: 'press_up' | 'touch' = 'press_up', nextScene?: string, shopType?: string) {
